...
export function MessagesPanel() {
  ...
  return (
    <div className="flex min-h-[min(72vh,680px)] w-full max-w-5xl flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm lg:flex-row">
      <div className="flex max-h-[min(40vh,360px)] shrink-0 flex-col border-b border-neutral-200 lg:max-h-none lg:w-[min(100%,340px)] lg:border-b-0 lg:border-r">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        {selected ? (
          <>
            <div className="flex items-start justify-between gap-3 border-b border-neutral-200 px-4 py-3 sm:px-5">
            ...
            <div className="min-h-0 flex-1 space-y-3 overflow-y-auto px-4 py-4 sm:px-5">
              <div className="rounded-xl border border-amber-100 bg-amber-50 px-3 py-2 text-xs text-amber-950">
                In-app messaging is not connected to Circle yet. Messages stay
                in this browser for demo threads only; event updates still
                appear under Notifications when the backend is connected.
              </div>
              {messages.length === 0 ? (
